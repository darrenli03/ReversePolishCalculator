...
public class IndependentReversePolishCalculatorV3 {
    public static void main(String[] args) {
        ...
        for (String newToken : formattedInput) {
            ...
            switch (newToken) {
                ...
                case "^" -> operators.push(newToken);
                case "+", "-" -> {
                    //pop all operator tokens that are of higher or equal precedence to the current operator token off the operator stack
